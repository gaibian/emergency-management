    ...
    <div class="car-collection-box main-page" ref="mainContainer">
        <div class="table-box">
            ...
            <el-table :data="tableData" :header-row-class-name="'table-header-box'" stripe :max-height="tableHeight" v-loading="tableLoading" element-loading-text="数据加载中...">
                ...
                <el-table-column label="经度" prop="eW"></el-table-column>
                <el-table-column label="纬度" prop="nS"></el-table-column>
                <el-table-column label="经度值" prop="latitude"></el-table-column>
                <el-table-column label="纬度值" prop="longitude"></el-table-column>
                <el-table-column label="卫星数量" prop="satelliteNum"></el-table-column>
            ...
            <!-- 编辑 -->
            <el-dialog title="原始数据信息" v-model="dialogFormVisible" :visible.sync="dialogFormVisible" :close-on-click-modal="false">
    ...
    methods:{
        ...
        handleDelete(id) {
            this.$confirm('确定删除该数据?','提示',{
                ...
                this.$api.dataAdmin.gpsDeletes(id).then(res => {
                    this.$message({
                        message:'删除成功',
                        type:'success'
                    })
        ...
        handlePag() {  //初始化加载列表 或者是更新列表
            ...
            this.$api.dataAdmin.gpsPage(this.queryForm).then(res => {
