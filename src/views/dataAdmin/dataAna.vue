    ...
    <div class="car-collection-box main-page" ref="mainContainer">
        <div class="table-box">
            <div class="top-info-box filter-container" ref="topAdd">
                ...
                <el-input class="filter-item" style="width:200px;" v-model="queryForm.driverName" placeholder="请输入设备名称"></el-input>
                <el-input class="filter-item" style="width:200px;" v-model="queryForm.driverNo" placeholder="请输入设备编号"></el-input>
            ...
            <el-table :data="tableData" :header-row-class-name="'table-header-box'" stripe :max-height="tableHeight" v-loading="tableLoading" element-loading-text="数据加载中...">
                ...
                <el-table-column label="设备名称" prop="driverName"></el-table-column>
                <el-table-column label="设备编号" prop="driverNo"></el-table-column>
                <el-table-column label="卡片电池电量" prop="batteryLevel"></el-table-column>
                <el-table-column label="卡片电池电压V" prop="batteryVol"></el-table-column>
                <el-table-column label="设备类型">
                    <template slot-scope="scope">
                        <span>{{scope.row.driverType | driverFilter}}</span>
                    </template>
                </el-table-column>
                <el-table-column label="设备原始值" prop="driver_value"></el-table-column>
                <el-table-column label="路线" prop="pathType"></el-table-column>
                <el-table-column label="解析值" prop="anaValue"></el-table-column>
                <el-table-column label="解析时间" min-width="150px">
                    <template slot-scope="scope">
                        <span>{{scope.row.collectTime | formatDate}}</span>
                    </template>
                </el-table-column>
    ...
    methods:{
        ...
        handleDelete(id) {
            this.$confirm('确定删除该数据?','提示',{
                ...
                this.$api.dataAdmin.analysisDeletes(id).then(res => {
                    this.$message({
                        message:'删除成功',
                        type:'success'
                    })
        ...
        handlePag() {  //初始化加载列表 或者是更新列表
            ...
            this.$api.dataAdmin.analysisPage(this.queryForm).then(res => {
