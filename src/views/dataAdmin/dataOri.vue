    ...
    <div class="car-collection-box main-page" ref="mainContainer">
        <div class="table-box">
            ...
            <el-table :data="tableData" :header-row-class-name="'table-header-box'" stripe :max-height="tableHeight" v-loading="tableLoading" element-loading-text="数据加载中...">
                <el-table-column label="主机编号" prop="hostNumber" min-width="130px"></el-table-column>
                <el-table-column label="原始数据" prop="content" min-width="400px"></el-table-column>
                <el-table-column label="采集时间" width="150px">
    ...
    methods:{
        ...
        handleDelete(id) {
            this.$confirm('确定删除该数据?','提示',{
                ...
                this.$api.dataAdmin.originalDeletes(id).then(res => {
                    this.$message({
                        message:'删除成功',
                        type:'success'
                    })
        ...
        handlePag() {  //初始化加载列表 或者是更新列表
            ...
            this.$api.dataAdmin.originalPage(this.queryForm).then(res => {
